        ...
        child: Column(
          ...
          children: [
              ...
              child: RichText(
                text: TextSpan(
                  ...
                  children: const <TextSpan>[
                    TextSpan(
                        text:
                        ' means the software program\nprovided by the Company downloaded by You\non any electronic device, named Currency\nConverter App by Currency.Wiki',
                        style: TextStyle(
                          fontSize: 15,
              ...
              child: RichText(
                text: TextSpan(
                  ...
                  children: const <TextSpan>[
                    TextSpan(
                        text:
                        ' (referred to as either the Company, We, Us or Our in this Agreement) refers to Currency.Wiki, 122 15th st #431 Del Mar, CA 92013.',
                        style: TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.w400,
                        )),
              ...
              child: RichText(
                text: TextSpan(
                  ...
                  children: const <TextSpan>[
                    TextSpan(
                        text:
                        ' refers to the purchase of a product, item, service or Subscription made through the Application and subject to these Terms and Conditions and/or the Application Store own terms and conditions.',
                        style: TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.w400,
                        )),
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text: 'MD Badsha Meah: https://freeicons.io/profile/3335\n',
                  style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15),
                  children: const <TextSpan>[
                    TextSpan(
                        text: 'icon king1: https://freeicons.io/profile/3\n',
                        style: TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.w500,
                        )),
                    TextSpan(
                        text:
                        'Freepik: https://www.flaticon.com/ & https://www.freepik.com\n',
                        style: TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.w500,
                        )),
                    TextSpan(
                        text: 'amCharts: https://www.amcharts.com/',
                        style: TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.w500,
                        )),
