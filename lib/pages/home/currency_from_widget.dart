  ...
  Widget build(BuildContext context) {
    return Center(
      child: AnimatedContainer(
        ...
        height: widget.isContainerVisible ? MediaQuery.of(context).size.height - 280 : 0.0,
                      ...
                      children: [
                        TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintStyle: TextStyle(fontSize: 17, color: Colors.black, fontWeight: FontWeight.w700),
                          ),
                        ),
                        Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            ...
                                            style: TextStyle(
                                                color: MyColors.insideTextFieldColor, fontSize: 17, fontWeight: FontWeight.bold),
                                          ),
                                          SizedBox(
                                          ...
                                          SizedBox(
                                            ...
                                            child: Text(
                                              model1.code.toUpperCase().tr() /*model1.name!*/,
                                              textScaleFactor: Constants.textScaleFactor,
                                              maxLines: 1,
