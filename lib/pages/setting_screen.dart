                      ...
                      if (_isContainerVisible) {
                        scrollController.animateTo(
                            scrollController.position.maxScrollExtent -
                                (scrollController.position.maxScrollExtent / 1.65),
                            ...
                            Row(
                              ...
                              children: [
                                Text("iso".tr().toString(),
                                    textScaleFactor: Constants.textScaleFactor,
                                    style: GoogleFonts.roboto(
                                        fontSize: 16, color: MyColors.textColor, fontWeight: FontWeight.w500)),
                            ...
                            child: Row(
                              children: [
                                ...
                                Text("A",
                                    ...
                                    style:
                                    GoogleFonts.roboto(
                                        fontSize: 17, color: MyColors.textColor, fontWeight: FontWeight.w500)),
                              ],
                            ),
                          ),
                          InkWell(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  ...
                                  style:
                                  GoogleFonts.roboto(
                                      fontSize: 18.5, color: MyColors.textColor, fontWeight: FontWeight.w500),
                                ),
                              ],
                            ),
                          ),
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  ...
                                  style:
                                  GoogleFonts.roboto(
                                      fontSize: 19.7, color: MyColors.textColor, fontWeight: FontWeight.w500),
                                ),
                              ],
                            ),
                          )
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Switch(
                                  ...
                                  activeTrackColor: MyColors.lightModeCheck ? MyColors.colorPrimary : Colors.black38,
                                  inactiveTrackColor: MyColors.darkModeCheck ? MyColors.colorPrimary : Colors.grey
                                      .shade300,
                                  activeColor: MyColors.textColor,
                                ),
                              ),
                              ...
                              Switch(
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    ...
                                    } else if (MyColors.displaycode) {} else {
                                      MyColors.displaycode = true;
                                      MyColors.displaysymbol = false;
                                    }
                                  ...
                                  Utility.setBoolDisplaysymbolPreference(
                                      Constants.SELECTED_SYMBOL, MyColors.displaysymbol);
                                },
                                activeTrackColor: MyColors.lightModeCheck ? MyColors.colorPrimary : Colors.black38,
                                activeColor: MyColors.textColor,
                              ),
                              ...
                              Switch(
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    ...
                                    } else if (MyColors.displaysymbol) {} else
                                    if (MyColors.displaysymbol && !MyColors.displayflag) {} else {
                                      MyColors.displaysymbol = true;
                                      MyColors.displaycode = false;
                                    }
                                  });
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Switch(
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    if (!MyColors.displaycode && !MyColors.displaysymbol) {} else
