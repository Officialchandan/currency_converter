                      ...
                      Container(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              await Utility.setStringPreference(Constants.primaryColorCode, lockSelectdColor.value.toRadixString(16));
                            ...
                            onPressed: () async {
                              ...
                              provider.purchaseUpdatedSubscription = FlutterInappPurchase.purchaseUpdated.listen((productItem) async {
                                if (productItem!.productId!.isNotEmpty) {
                                  ...
                                  provider.logEvent(eventName: "colorEvent", eventValues: eventValues);
                                  ...
                                  if (colorSelection != null) {
                                    ...
                                    await dbHelper.deSelectColor();
                                    String colorCode = lockSelectdColor.value.toRadixString(16);
                                  ...
                                  await Utility.setStringPreference(
                                      Constants.primaryColorCode, colorSelection!.value.toRadixString(16));

                                  Utility.setStringPreference(Constants.selectedLockedColor, colorSelection!.value.toRadixString(16));

                                  Utility.notifyThemeChange();
                                  widget.onThemeChange();
                                  Navigator.pushAndRemoveUntil(
                                      context, MaterialPageRoute(builder: (_) => MyTabBarWidget()), (route) => true);
                                  Navigator.pop(context);
                                  Navigator.pop(context);
                                  setState(() {});
                                }
                            ...
                            return Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  ...
                                  await Utility.setStringPreference(
                                      Constants.primaryColorCode, unlockSelectdColor!.value.toRadixString(16));
                                  Utility.notifyThemeChange();
