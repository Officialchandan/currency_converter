...
class MyColors {
  static Color colorPrimary =
      Colors.lightBlue; //{ this is a color ,which change whole theme }
  static Color firstthemecolorgr1 = Colors
      .grey; //{ this is a gradient color of theme which is always with  'firstthemecolorgr' }

  static Color calcuColor = Color(
      0xFFB2BBF5); //{  this is a color of calculator button, we need to take this because some time it change some time not}
  ...
  static int textSize =
      2; //{ This is integer value of size ,to increment or decrement the size of fonts}
  static bool fontsmall = false; //{ this is for doing small font by a variable}
  static bool fontmedium =
      true; //{ this is also same like about but it is for medium font and it will be by default}
