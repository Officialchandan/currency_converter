...
import com.currencywiki.currencyconverter.adapter.CurrencyCodeAdapter
import com.currencywiki.currencyconverter.api.ApiClient
import com.currencywiki.currencyconverter.databinding.ActivityListWidgetConfigBinding
...
import com.currencywiki.currencyconverter.utils.Utility.Companion.getColorWithAlpha
import com.currencywiki.currencyconverter.widget.ListWidgetKt
...
//                            currencyList.add(Country(currencyFlag.getDrawable(index)!!, currencyCode[index], currencyName[index], "", 1, 0))
                            ...
                            Log.e(
                                com.currencywiki.currencyconverter.MainActivity::class.java.name,
